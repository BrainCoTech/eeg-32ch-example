...
export const set_leadoff_config: (a: number, b: number, c: number) => number;
...
export const get_ble_config: () => number;
export const set_ble_config: (a: number, b: number, c: number, d: number) => number;
