...
export const starkota_trigger_dfu_state: (a: number, b: number) => void;
export const starkota_trigger_dfu_progress: (a: number, b: number) => void;
...
export const apply_high_pass_filter: (a: number, b: number, c: number, d: number, e: number) => void;
export const apply_band_pass_filter: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
export const apply_band_stop_filter: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
export const apply_low_pass_filter: (a: number, b: number, c: number, d: number, e: number) => void;
