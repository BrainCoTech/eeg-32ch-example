 ...
 * @returns {any}
 */
module.exports.get_leadoff_config = function() {
    const ret = wasm.get_leadoff_config();
    return takeObject(ret);
};
 ...
 * @returns {any}
 */
module.exports.get_ble_device_info = function() {
    const ret = wasm.get_ble_device_info();
    return takeObject(ret);
};
 ...
 * @returns {any}
 */
module.exports.set_ble_device_info = function(model, sn) {
    ...
    const ret = wasm.set_ble_device_info(ptr0, len0, ptr1, len1);
    return takeObject(ret);
};
 ...
 */
module.exports.remove_env_noise = function(data, channel) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArrayF64ToWasm0(data, wasm.__wbindgen_export_3);
        const len0 = WASM_VECTOR_LEN;
        wasm.remove_env_noise(retptr, ptr0, len0, channel);
 ...
 * @returns {Float64Array}
 */
module.exports.apply_eeg_filters = function(data, channel) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArrayF64ToWasm0(data, wasm.__wbindgen_export_3);
        const len0 = WASM_VECTOR_LEN;
        wasm.apply_eeg_filters(retptr, ptr0, len0, channel);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var v2 = getArrayF64FromWasm0(r0, r1).slice();
        wasm.__wbindgen_export_1(r0, r1 * 8, 8);
...
/**
 * @param {HighPassFilter} filter
 * @param {Float64Array} data
 * @returns {Float64Array}
 */
module.exports.apply_highpass = function(filter, data) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(filter, HighPassFilter);
        const ptr0 = passArrayF64ToWasm0(data, wasm.__wbindgen_export_3);
        const len0 = WASM_VECTOR_LEN;
        wasm.apply_highpass(retptr, filter.__wbg_ptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var v2 = getArrayF64FromWasm0(r0, r1).slice();
        wasm.__wbindgen_export_1(r0, r1 * 8, 8);
...
/**
 * @param {LowPassFilter} filter
 * @param {Float64Array} data
 * @returns {Float64Array}
 */
module.exports.apply_lowpass = function(filter, data) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(filter, LowPassFilter);
        const ptr0 = passArrayF64ToWasm0(data, wasm.__wbindgen_export_3);
        const len0 = WASM_VECTOR_LEN;
        wasm.apply_lowpass(retptr, filter.__wbg_ptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var v2 = getArrayF64FromWasm0(r0, r1).slice();
        wasm.__wbindgen_export_1(r0, r1 * 8, 8);
...
/**
 * @param {BandPassFilter} filter
 * @param {Float64Array} data
 * @returns {Float64Array}
 */
module.exports.apply_bandpass = function(filter, data) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(filter, BandPassFilter);
        const ptr0 = passArrayF64ToWasm0(data, wasm.__wbindgen_export_3);
        const len0 = WASM_VECTOR_LEN;
        wasm.apply_bandpass(retptr, filter.__wbg_ptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var v2 = getArrayF64FromWasm0(r0, r1).slice();
        wasm.__wbindgen_export_1(r0, r1 * 8, 8);
...
/**
 * @param {BandStopFilter} filter
 * @param {Float64Array} data
 * @returns {Float64Array}
 */
module.exports.apply_bandstop = function(filter, data) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(filter, BandStopFilter);
        const ptr0 = passArrayF64ToWasm0(data, wasm.__wbindgen_export_3);
        const len0 = WASM_VECTOR_LEN;
        wasm.apply_bandstop(retptr, filter.__wbg_ptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var v2 = getArrayF64FromWasm0(r0, r1).slice();
        wasm.__wbindgen_export_1(r0, r1 * 8, 8);
 ...
 */
module.exports.set_msg_resp_callback = function(callback) {
    wasm.set_msg_resp_callback(addHeapObject(callback));
};

/**
 * @param {Function} callback
 */
module.exports.set_tcp_write_callback = function(callback) {
    wasm.set_tcp_write_callback(addHeapObject(callback));
};

/**
 * @param {boolean} loop_check
 * @param {LeadOffFreq} freq
 * @param {LeadOffCurrent} current
 * @param {Function} impedance_callback
 */
module.exports.start_leadoff_check = function(loop_check, freq, current, impedance_callback) {
    wasm.start_leadoff_check(loop_check, freq, current, addHeapObject(impedance_callback));
};

module.exports.stop_leadoff_check = function() {
    wasm.stop_leadoff_check();
};
...
module.exports.EegSampleRate = Object.freeze({
    SR_None: 0, "0": "SR_None",
    SR_250Hz: 1, "1": "SR_250Hz",
    SR_500Hz: 2, "2": "SR_500Hz",
    SR_1000Hz: 3, "3": "SR_1000Hz",
    SR_2000Hz: 4, "4": "SR_2000Hz",
});
/**
 * @enum {0 | 1 | 2 | 3 | 4 | 5 | 6 | 7}
 */
 ...
 * @enum {0 | 1 | 2 | 3 | 4}
 */
module.exports.LeadOffChip = Object.freeze({
    None: 0, "0": "None",
    Chip1: 1, "1": "Chip1",
    Chip2: 2, "2": "Chip2",
    Chip3: 3, "3": "Chip3",
 ...
 * @enum {0 | 1 | 2 | 3 | 4}
 */
module.exports.LeadOffCurrent = Object.freeze({
    None: 0, "0": "None",
    Cur6nA: 1, "1": "Cur6nA",
    Cur24nA: 2, "2": "Cur24nA",
    Cur6uA: 3, "3": "Cur6uA",
 ...
 * @enum {0 | 1 | 2 | 3 | 4}
 */
module.exports.LeadOffFreq = Object.freeze({
    None: 0, "0": "None",
    Dc: 1, "1": "Dc",
    Ac7p8hz: 2, "2": "Ac7p8hz",
    Ac31p2hz: 3, "3": "Ac31p2hz",
    AcFdr4: 4, "4": "AcFdr4",
});
/**
 * @enum {0 | 1 | 2 | 3 | 4 | 5 | 6 | 7}
...
class BandPassFilter {
     ...
     */
    get a() {
        const ret = wasm.__wbg_get_bandpassfilter_a(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set a(arg0) {
        wasm.__wbg_set_bandpassfilter_a(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get d1() {
        const ret = wasm.__wbg_get_bandpassfilter_d1(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set d1(arg0) {
        wasm.__wbg_set_bandpassfilter_d1(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get d2() {
        const ret = wasm.__wbg_get_bandpassfilter_d2(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set d2(arg0) {
        wasm.__wbg_set_bandpassfilter_d2(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get d3() {
        const ret = wasm.__wbg_get_bandpassfilter_d3(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set d3(arg0) {
        wasm.__wbg_set_bandpassfilter_d3(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get d4() {
        const ret = wasm.__wbg_get_bandpassfilter_d4(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set d4(arg0) {
        wasm.__wbg_set_bandpassfilter_d4(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get w0() {
        const ret = wasm.__wbg_get_bandpassfilter_w0(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set w0(arg0) {
        wasm.__wbg_set_bandpassfilter_w0(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get w1() {
        const ret = wasm.__wbg_get_bandpassfilter_w1(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set w1(arg0) {
        wasm.__wbg_set_bandpassfilter_w1(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get w2() {
        const ret = wasm.__wbg_get_bandpassfilter_w2(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set w2(arg0) {
        wasm.__wbg_set_bandpassfilter_w2(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get w3() {
        const ret = wasm.__wbg_get_bandpassfilter_w3(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set w3(arg0) {
        wasm.__wbg_set_bandpassfilter_w3(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get w4() {
        const ret = wasm.__wbg_get_bandpassfilter_w4(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set w4(arg0) {
        wasm.__wbg_set_bandpassfilter_w4(this.__wbg_ptr, arg0);
    }
    /**
     * @param {number} _order
     * @param {number} s
     ...
     * @param {number} fu
     */
    constructor(_order, s, fl, fu) {
        const ret = wasm.bandpassfilter_new(_order, s, fl, fu);
        this.__wbg_ptr = ret >>> 0;
        BandPassFilterFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
module.exports.BandPassFilter = BandPassFilter;

const BandStopFilterFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_bandstopfilter_free(ptr >>> 0, 1));
...
class BandStopFilter {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        BandStopFilterFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_bandstopfilter_free(ptr, 0);
    }
    /**
     * @returns {number}
     */
     ...
     */
    get r() {
        const ret = wasm.__wbg_get_bandstopfilter_r(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set r(arg0) {
        wasm.__wbg_set_bandstopfilter_r(this.__wbg_ptr, arg0);
    }
    /**
     * @returns {number}
     */
    get s() {
        const ret = wasm.__wbg_get_bandstopfilter_s(this.__wbg_ptr);
        return ret;
    }
    /**
     * @param {number} arg0
     */
    set s(arg0) {
        wasm.__wbg_set_bandstopfilter_s(this.__wbg_ptr, arg0);
    }
    /**
     * @param {number} _order
     * @param {number} s
     ...
     */
    constructor(_order, s, fl, fu) {
        const ret = wasm.bandstopfilter_new(_order, s, fl, fu);
        this.__wbg_ptr = ret >>> 0;
        BandStopFilterFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
module.exports.BandStopFilter = BandStopFilter;
...
class HighPassFilter {
     ...
     * @param {number} f
     */
    constructor(_order, s, f) {
        const ret = wasm.highpassfilter_new(_order, s, f);
        this.__wbg_ptr = ret >>> 0;
        HighPassFilterFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
module.exports.HighPassFilter = HighPassFilter;
...
class LowPassFilter {
     ...
     */
    constructor(_order, s, f) {
        const ret = wasm.lowpassfilter_new(_order, s, f);
        this.__wbg_ptr = ret >>> 0;
        LowPassFilterFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
module.exports.LowPassFilter = LowPassFilter;
...
const SosFilterFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_sosfilter_free(ptr >>> 0, 1));
...
class SosFilter {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        SosFilterFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_sosfilter_free(ptr, 0);
    }
}
module.exports.SosFilter = SosFilter;
...
module.exports.__wbg_call_3b770f0d6eb4720e = function() { return handleError(function (arg0, arg1, arg2, arg3) {
...
module.exports.__wbg_instanceof_Uint16Array_acb683ac2888f3f2 = function(arg0) {
    let result;
    try {
...
module.exports.__wbg_length_109fc2552bd44dc0 = function(arg0) {
...
module.exports.__wbg_modbusreadholdingregistervalues_7a48745fc86cc369 = function(arg0, arg1, arg2) {
    const ret = modbus_read_holding_register_values(arg0, arg1, arg2);
    return addHeapObject(ret);
};

module.exports.__wbg_modbusreadinputregistervalues_e8233c8b34845fa5 = function(arg0, arg1, arg2) {
    const ret = modbus_read_input_register_values(arg0, arg1, arg2);
    return addHeapObject(ret);
};

module.exports.__wbg_new_07e67105850d6032 = function(arg0) {
...
module.exports.__wbg_set_84ba672b563476ae = function(arg0, arg1, arg2) {
    getObject(arg0).set(getObject(arg1), arg2 >>> 0);
};

module.exports.__wbg_starkmodbuswrite_f733a3e172f006eb = function(arg0, arg1, arg2, arg3) {
...
module.exports.__wbindgen_closure_wrapper1787 = function(arg0, arg1, arg2) {
    const ret = makeClosure(arg0, arg1, 641, __wbg_adapter_44);
    return addHeapObject(ret);
};

module.exports.__wbindgen_closure_wrapper2583 = function(arg0, arg1, arg2) {
...
module.exports.__wbindgen_float32_array_new = function(arg0, arg1) {
